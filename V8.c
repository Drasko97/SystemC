...
unsigned char WriteBuf[5];
 ...
 unsigned char g8563_Store[6];
				 // sec,min,sat, dan, mje, god
 unsigned char init8563_Store[6]={0x00,0x59,0x08,0x00,0x00, 0x00 };
...
void P8563_Readtime()
{
   ...
   g8563_Store[4] = time[4] & 0x1f;//mje
   g8563_Store[5] = time[5] & 0x3f;//god
...
int main(int argc, char **argv)
{
  ...
  {
   P8563_Readtime();
   printf("Godina:%d Mjesec: %d Dan:%d Sati:%d Minuti:%d Sekunde:%d\n", g8563_Store[2], g8563_Store[1], g8563_Store[0]);
   bcm2835_delay(5000);
}
